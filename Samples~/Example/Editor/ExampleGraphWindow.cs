...
namespace TaoTie.Inspector.Example
{
    public class ExampleGraphWindow: GraphWindow<ExampleGraph>
    {
        ...
        [MenuItem("Window/TaoTie Inspector/ExampleGraphWindow")]
        ...
        {
            string searchPath = EditorUtility.OpenFilePanel($"New {nameof(ExampleGraph)} Configuration File", "Assets", "asset");
        ...
        protected override void SaveGraph()
        {
            ...
            {
                string searchPath = EditorUtility.SaveFilePanel($"New {nameof(ExampleGraph)} Configuration File", "Assets",
        ...
        protected override void AddNodeMenuItems(GenericMenu menu, NodeBase nodeBase)
        {
            ...
            menu.AddItem(new GUIContent("AddInputPort"), false,
                () => {
                    ...
                    m_Points = null; m_Ports = null; m_EdgeViews = null;
                    m_PointsDirty = true; m_Dirty = true; Repaint();
                });

...
namespace TaoTie.Inspector
{
    public class ExampleMonoBehaviour : MonoBehaviour
    {
        ...
        [Button("Reset Combat Attributes")]
        private void ResetCombatStats()
        {
            obj.attack = 10f;
            obj.defense = 5f;
            obj.criticalRate = 0.1f;
            obj.criticalDamage = 1.5f;
            Debug.Log("[TaoTie Inspector] Combat attributes have been reset!");
        }
        ...
        private void LevelUp()
        {
            obj.level++;
            obj.maxHealth += 10f;
            Debug.Log($"[TaoTie Inspector] Leveled up to Lv.{obj.level}, Max Health: {obj.maxHealth}");
        }

        [Button("Full Heal")]
        private void FullHeal()
        {
            Debug.Log($"[TaoTie Inspector] Restored to full health: {obj.maxHealth}");
        }
        ...
        public static System.Collections.Generic.IEnumerable<System.Type> GetFilteredSkillTypes()
        {
        ...
        [SerializeReference]
        public BaseSkill disabledHiddenPickerSkill = new DefenseSkill();
        ...
        {
            Debug.Log($"[OnCollectionChanged] callbackList count={callbackList.Count}, callbackTableList count={callbackTableList.Count}");
        }
        ...
        [ValueDropdown(nameof(GetInspectorDropdownInts))]
        ...
        [ValueDropdown(nameof(GetInspectorDropdownInts), AppendNextDrawer = true)]
        ...
        [ValueDropdown(nameof(GetInspectorDropdownStrings))]
        ...
        [ValueDropdown(nameof(GetInspectorDropdownEnumValues))]
        ...
        public static IEnumerable<ValueDropdownItem> GetInspectorDropdownInts()
        {
            for (int i = 0; i <= 5; i++)
                yield return new ValueDropdownItem("Value_" + i, i);
        }

        public static IEnumerable<ValueDropdownItem> GetInspectorDropdownStrings()
        {
        ...
        public static IEnumerable<ValueDropdownItem> GetInspectorDropdownEnumValues()
        {
        ...
        public string hiddenInDetails = "only in node view";
    ...
    /// <summary>
    /// Static helper class for testing cross-class method calls in attributes.
    /// </summary>
    public static class TestStaticHelper
    {
        ...
        public static System.Collections.Generic.IEnumerable<System.Type> GetStaticSkillTypes()
        {
            yield return typeof(AttackSkill);
            yield return typeof(HealSkill);
        }
    ...
    [Serializable]
    public class CrossClassTestObject
    {
        [Title("Cross-Class Static Method Test", true)]
